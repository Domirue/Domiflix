# Domiflix – Advanced Web Application
...
2. Uruchom moduły **Apache** oraz **MySQL** w panelu XAMPP.
3. Otwórz phpMyAdmin (`http://localhost/phpmyadmin`).
4. Utwórz nową bazę danych.
5. Zaimportuj plik `filmy.sql` do utworzonej bazy.
6. W razie potrzeby dostosuj dane połączenia z bazą danych w plikach projektu.
7. Otwórz w przeglądarce adres:
